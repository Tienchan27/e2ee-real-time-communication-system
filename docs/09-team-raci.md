...
| --------- | ------------------------ | --------- | --------- | --------- | -------- | ----------- | --------------- |
| W3-API-01 | Endpoint request OTP     | API Owner | 0.5 ngày  | W2-API-02 | Tự điền  | In Progress | PR link + test  |
| W3-FE-02  | Màn nhập OTP + countdown | FE Owner  | 0.5 ngày  | W3-API-01 | Tự điền  | Todo        | Screenshot + PR |
...
| Điều kiện merge        | >= 1 approval từ owner hoặc System Owner, CI pass                |
...
- Bị chặn > 24 giờ: escalate System Owner và kích hoạt fallback task.
